<script>
    $.ajax({
        type: 'get',
        async: false,
        url: '/admin/__plural__/categories',
    ...
    function updateRow(field, row, old, $el) {
        $.ajax({
            url: '/admin/__plural__/' + row.id + '/save',
            type: 'post',
    ...
    window.actionEvents = {
        ...
        'click .top': function (e, value, row, index) {
            $.ajax({
                url: '/admin/__plural__/' + row.id + '/top',
                type: 'post',
        ...
        'click .tag': function (e, value, row, index) {
            $.ajax({
                url: '/admin/__plural__/' + row.id + '/tag',
                type: 'post',
        ...
        'click .comment': function (e, value, row, index) {
            ...
            var url = '/admin/__plural__/comments/' + row.id;
            $.ajax({
                url: url,
                type: "get",
                data: {'_token': '{{ csrf_token() }}'},
