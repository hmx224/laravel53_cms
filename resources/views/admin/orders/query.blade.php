                            ...
                            <form id="form_query" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            {!! Form::select('type',\App\Models\Order::getTypes(),null ,['class' => 'form-control col-sm-2']) !!}
                                        </div>
                                        <label class="col-sm-2 control-label">支付类型:</label>
                                        <div class="col-sm-4">
                                            {!! Form::select('pay_type',\App\Models\Order::getPayTypes(),null ,['class' => 'form-control col-sm-2']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="start_date" class="control-label col-sm-2">创建时间:</label>
                                        <div class="col-sm-4">
                                        ...
                                        <label for="end_date" class="control-label col-sm-2">至:</label>
                                        <div class="col-sm-4">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button class="btn btn-info pull-right" id="btn_query" data-dismiss="modal">查询</button>
