...
CKEDITOR.dialog.add('image2', function (editor) {
    ...
    var regexGetSizeOrEmpty = /(^\s*(\d+)(px)?\s*$)|^$/i,
        ...
        lockButton, resetButton, widthField, heightField, watermarkField,
    ...
    function toggleWatermark(enable) {
        console.log(enable);
    }
                ...
                elements: [
                    ...
                    },
                    {
                        ...
                        onChange: function (widget) {
                            CKEDITOR.tools.setCookie('watermark', widget.data.value);
                        },
                        setup: function (widget) {
                            CKEDITOR.tools.setCookie('watermark', false);
                        }
                    },
                    {
                        type: 'fileButton',
